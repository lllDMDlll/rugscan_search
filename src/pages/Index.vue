<template>
  <q-page class="flex flex-center">
    <section class="column full-width flex flex-center">
      <section class="row flex flex-center full-width">
        <q-input
          style="width: 90%; max-width: 600px; margin-top: 15px; margin-bottom: 15px"
          standout
          bottom-slots
          v-model="text"
      ...
      <section v-if="this.searchResults.length === 0" class="row">
